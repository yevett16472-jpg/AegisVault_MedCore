...
| :--- | :--- | :--- |
| **01** | `AegisVault_MedCore_main.py` | Central entry point governing initialization and system-wide matrix validation. |
| **02** | `Pandora_Engine_Controller.py` | Manages compartmentalized logic flow, secure routing, and component isolation. |
| **03** | `Sovereign_Agent_Router.py` | Directs internal agent handoffs while blocking external API sniffing. |
| **04** | `System_Config_Loader.py` | Ingests local environment parameters, keys, and operational variables securely. |
| **05** | `Data_Schema_Manager.py` | Enforces strict SQL schemas and database structures (including surge/medical tracking logs). |
| **06** | `Telemetry_Logging_Service.py` | Monitors internal diagnostics and system metrics entirely within the local enclave. |
| **07** | `Pipeline_Execution_Orchestrator.py` | Coordinates multi-threaded data pipelines and automated task scheduling. |
